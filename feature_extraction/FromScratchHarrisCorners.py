...
from core_operations.FromScratchConvolve2d import myconvolve2d
from core_operations.FromScratchGaussianBlur import FromScratchGaussianBlur
from core_operations.FromScratchSobel import FromScratchSobel
...
if __name__ == "__main__":
    img = cv2.imread("/Users/anvay-coder/cv2-from-scratch/cat.png", cv2.IMREAD_GRAYSCALE)
    ksize_sobel = (3,3)
    ksize_gaussian = (3,3)
    sigmaX = 1
    alpha = 0
